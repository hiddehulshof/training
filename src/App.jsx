    ...
    <div className="min-h-screen bg-slate-50 font-sans text-slate-800 pb-12">
      ...
      <div className="max-w-md mx-auto p-4 space-y-6">
        ...
        <div className="flex justify-between items-center bg-white p-2 rounded-lg shadow-sm">
          <button onClick={prevDay} className="p-2 bg-gray-100 hover:bg-gray-100 rounded-full"><ChevronLeft className="w-5 h-5" /></button>
          ...
          <button onClick={nextDay} className="p-2 bg-gray-100 hover:bg-gray-200 rounded-full"><ChevronRight className="w-5 h-5" /></button>
        </div>
